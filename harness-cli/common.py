...
harness_host = os.getenv('HARNESS_SERVER_ADDRESS', 'localhost')
harness_port = os.getenv('HARNESS_SERVER_PORT', 9090)

if os.getenv('HARNESS_AUTH_SERVER_PROTECTED') == 'true' or os.getenv('HARNESS_CLI_AUTH_ENABLED') == 'true':
    auth_enabled = True
    # print('Auth enabled')
else:
    auth_enabled = False
...
if os.getenv('HARNESS_CLI_SSL_ENABLED') == 'true':
